...
class CustomizableDatagrid extends react_1.default.Component {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", null, react_1.default.createElement("div", { style: { float: 'right', marginRight: '1rem' } }, react_1.default.createElement(Button_1.default, { variant: "outlined", "aria-label": "add", size: "small", onClick: (e) => this.handleOpen(e) }, react_1.default.createElement(ViewColumn_1.default, null))), react_1.default.createElement(react_admin_1.Datagrid, Object.assign({}, rest), react_1.default.Children.map(children, this.renderChild))));
    }
}
