...
const SelectionDialog_1 = __importDefault(require("./SelectionDialog"));
const LocalStorage_1 = __importDefault(require("./LocalStorage"));
/**
 *
 */
class CustomDatagrid extends react_1.default.Component {
    constructor(props) {
        super(props);
    ...
    getColumnLabels() {
        const { children } = this.props;
        const data = (0, filter_1.default)(react_1.default.Children.map(children, field => field && {
    ...
    render() {
        ...
        return (react_1.default.createElement("div", null,
            ...
            modalOpened && (react_1.default.createElement(SelectionDialog_1.default, { selection: selection, columns: this.getColumnLabels(), onColumnClicked: this.toggleColumn, onClose: this.handleClose })),
...
exports.default = CustomDatagrid;
